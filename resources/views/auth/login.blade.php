        ...
        <div class="col-md-4 col-md-offset-4">
            <div class="login-panel panel panel-default">
                ...
                <div class="panel-body">
                    <div class="panel-heading" align="center">
                        <h3 class="panel-title" align="center">Ingresar</h3>
                    </div>
                    {!!Form::open(['route'=>'login','method'=>'POST', 'role'=>'form']) !!}
                        ...
                        <fieldset>
                            ...
                            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                <input class="form-control" placeholder="Password" name="password" type="password" id="password" required value="">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input name="remember" type="checkbox" {{ old('remember') ? 'checked' : '' }}">Recordarme
                                </label>
                            </div>
